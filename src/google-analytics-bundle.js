...
(function() {
    ...
    var Ea,
        ...
        Oa = function(a) {
            if (1 > a || 200 < a)
                throw Error(
                    "Expected dimension index range 1-200, but was : " + a
                );
            return {
                id: "dimension" + a,
                name: "cd" + a,
        ...
        Pa = function(a) {
            if (1 > a || 200 < a)
                throw Error(
                    "Expected metric index range 1-200, but was : " + a
                );
            return {
                id: "metric" + a,
                name: "cm" + a,
        ...
        Ra = function(a, b) {
            for (var c = 0, d = a.length - 1, e = 0; c <= d; ) {
                ...
                if (b <= e) {
                    ...
                    if (f >= a.length - 1)
                        return (a[a.length - 1] + 1).toString() + "+";
                    c = f + 1;
                }
            }
            return "<= 0";
    ...
    var Ta = function(a, b) {
        if (null != a.Ga)
            throw Error(
                "LabelerBuilder: Only one labeling strategy may be used."
            );
        a.Ga = t(function(a) {
            var d = a.ba().get(Ma),
                e = a.ba().get(La);
    ...
    E.prototype.set = function(a, b) {
        if (null == b)
            throw Error("undefined-or-null value for key: " + a.name);
    ...
    var tb = function(a, b) {
        ...
        if (a) {
            ...
            null === d
                ? ((this.offsetX =
                      eb || void 0 !== a.offsetX ? a.offsetX : a.layerX),
                  (this.offsetY =
                      eb || void 0 !== a.offsetY ? a.offsetY : a.layerY),
    ...
    var zb = function(a, b, c, d) {
        for (var e = 0; e < a.length; ++e) {
            var f = a[e];
            if (!f.removed && f.listener == b && f.sa == !!c && f.Aa == d)
                return e;
        }
        return -1;
    };
...
*/
            ...
            for (var b = a.M, d = (c = !1); a.Ma.length && !a.Ua; ) {
                ...
                if ((f = a.ka ? g : f))
                    try {
                        ...
                        m(l) &&
                            ((a.ka = a.ka && (l == b || l instanceof Error)),
                            (a.M = b = l));
                        if (
                            gc(b) ||
                            ("function" === typeof k.Promise &&
                                b instanceof k.Promise)
                        )
                            (d = !0), (a.Ua = !0);
                    } catch (x) {
                        (b = x), (a.ka = !0), Dc(a) || (c = !0);
    ...
    h.set = function(a, b) {
        if (null == b)
            throw Error(
                "Value must be defined and not null. Parameter=" + a.id
            );
        var c = $c(a);
        this.Mb.set(c, b);
    };
        ...
        if (this.enabled) {
            ...
            0 < a && a < 0.8 * this.Ea
                ...
                : (this.l && (this.fa.clearTimeout(this.l), (this.l = null)),
                  ...
                  this.enabled &&
                      ((this.l = this.fa.setTimeout(this.Va, this.Ea)),
                      (this.hb = u())));
        }
    };
    h.start = function() {
    ...
    Z.prototype.A = function() {
        this.a &&
            (this.N &&
                ((this.N = !1), (this.V = !0), this.a.abort(), (this.V = !1)),
            Zd(this, !0));
        Z.W.A.call(this);
    };
    ...
    h.L = function() {
        ee(this);
        for (
            var a = this.c.v(), b = this.c.L(), c = [], d = 0;
            d < b.length;
            d++
        )
